...
public class Home extends JFrame implements ActionListener
{
    ...
    public Home()
    {
        ...
        l7=new JLabel(i18);
        l7.setBounds(300,160,134,128);
        contentPane.add(l7);

        JPanel panel2=new JPanel();
        panel2.setBorder(new TitledBorder(new LineBorder(new Color(205,133,63),2),"Operation",TitledBorder.LEADING,
